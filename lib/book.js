...
export async function getBook(id) {
  ...
  fields: ["id", "title", "authors", "publishedDate", "description", "image","publisher"]
...
listPriceAmount : saleInfo && saleInfo.listPrice ? saleInfo.listPrice.amount : null,
currencyCode : saleInfo && saleInfo.listPrice ? saleInfo.listPrice.currencyCode : null,
